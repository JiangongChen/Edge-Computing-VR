...
public class Stats {
    ...
    public static ArrayList<String> repFrames = new ArrayList<>();
    public static ArrayList<String> skipFrames = new ArrayList<>();

    // accuracy
    public static int nTotalDisplayed = 0;
    public static String lastDisplayed = null;
    public static int repFrameCnt = 0;
    public static int skipFrameCnt = 0;
